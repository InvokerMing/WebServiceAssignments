...
user_storage = UserStorage(db_path=os.environ.get('DB_PATH', 'urls.db'))
...
if __name__ == '__main__':
    ...
    auth_app.register_blueprint(auth_bp, url_prefix='/auth')
    auth_app.run(port=5001, debug=True, host='0.0.0.0')